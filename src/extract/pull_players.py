...
def main():
    ...
    for player in players:
        commonplayerinfo.CommonPlayerInfo(player_id=player.get("id")).get_dict()
        common_player_info_res = commonplayerinfo.CommonPlayerInfo(player_id=player.get("id")).get_dict()
